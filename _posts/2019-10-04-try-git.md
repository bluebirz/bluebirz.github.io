...
toc:
  sidebar: left
thumbnail: /assets/img/features/yancy-min-842ofHC6MaI-unsplash.jpg
---
![feature img](/assets/img/features/yancy-min-842ofHC6MaI-unsplash.jpg){:loading="lazy"}
*[Unsplash / Yancy Min](https://unsplash.com/photos/a-close-up-of-a-text-description-on-a-computer-screen-842ofHC6MaI)*

Hi! Hi! All guys~

Previously I talked about [Docker]({{ site.url }}{% link _posts/2019-09-19-try-docker.md %}) for afford us programmers the ready-to-eat environments. This time it’s the turn of source code as we have to write them for tens or hundreds files. Let’s see what can be happened:
...
![git flow](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/git_v01.png){:loading="lazy"}
...
<table>
  <tr>
    ...
    <td><p><strong><a href="https://github.com/" target="_blank">Github</a></strong> A famous Git server. I guess you once heard its name. Its spotlight is a large open-source community.</p></td>
  </tr>
  <tr>
...
![make repo](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-01-at-20.46.48.png){:loading="lazy"}
...
![ssh-keygen](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-01-at-22.10.00.png){:loading="lazy"}

#### 5.2 Add our public key

Add our public key (in `.pub` file) to SSH key setting page of our Git account.

![add pubkey](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-01-at-22.16.28.png){:loading="lazy"}
...
![git init](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-01-at-22.19.14.png){:loading="lazy"}

> ##### IMPORTANT
>
> Only files placed inside a folder with .git can be detected and moved to Git server.
{: .block-warning}
...
![clone ssh](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-01-at-22.37.55.png){:loading="lazy"}
...
![git remote add](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-01-at-22.39.21.png){:loading="lazy"}
...
![git clone](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.09.17.png){:loading="lazy"}
...
![cd](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.07.27.png){:loading="lazy"}
...
![git status](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.00.05.png){:loading="lazy"}

This below show a fresh empty file named `test.txt`.

![touch file](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.01.41.png){:loading="lazy"}
...
![git add](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.02.14.png){:loading="lazy"}
...
![git rm](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.02.57.png){:loading="lazy"}
...
![git commit](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.04.21.png){:loading="lazy"}
...
![git push](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.05.06.png){:loading="lazy"}

### 12. Check it out on Git server

![check at github page](https://bluebirzdotnet.s3.ap-southeast-1.amazonaws.com/try-git/Screen-Shot-2562-10-02-at-23.11.10.png){:loading="lazy"}
