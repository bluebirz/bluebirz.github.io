...
From [EP 4]({% post_url 2020-02-27-data-sci-4 %}), we could know all types of Linear regression. Linear regression is just one of 4 Machine Learning (ML) algorithms.
