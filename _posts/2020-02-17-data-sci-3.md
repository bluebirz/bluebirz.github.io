...
Continued from [EP 2]({% post_url 2020-01-24-data-sci-2 %}), we gonna find out the advance visualizations. We now have some basic stuff of `matplotlib`, so we will create its graphs in more complex way.
